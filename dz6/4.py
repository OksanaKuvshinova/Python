...
class Car():
    ...
    def __init__(self, max_speed, color, name, is_police):
        self.max_speed = max_speed  # максимально возможная скорость для автомобиля
        self.color = color
        self.name = name
    ...
    def show_speed(self, speed):
        # Для сокращения объема кода здесь добавлена проверка на превышение максимальной скорости
        self.speed = speed
